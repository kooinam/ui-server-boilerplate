...
import { TableParams, getAxios, LoaderContent, ModalParams, matchRouteProperty } from 'awry-utilities';
      ...
      <Row>
        ...
        >
          <Col sm={12} xs={24} md={8} lg={6}>
            ...
            >
              <Link
                className={`link-primary ${styles.StashLink}`}
                to="#"
              ...
              return (
                <Col sm={12} xs={24} lg={6} md={8} key={item.id}>
                  <Card
                    className={styles.StashCard}
                  >
                    <Link className={`link-primary ${styles.StashLink}`} to={`${this.state.urlPrefix}/stashes/${item.id}`}>
                      <div className={styles.StashCoverPhoto}>
