...
import SessionSection from '../admin_components/SessionSection';
...
class SessionPage extends React.Component {
  ...
  handleClickTab = (tab) => {
    this.props.dispatch(push(`/admin/sessions/${this.props.match.params.sessionId}/${tab}`));
  }
    ...
    return (
      ...
      >
        ...
        <Tabs.TabPane tab="Activities" key="activities">
          <ActivitiesSection session={this.state.itemLoader.item} loadItem={this.loadItem} />
        </Tabs.TabPane>
      </Tabs>
    );
  }
